...
export class ProductFinderSchedulerStack extends Stack {
    ...
    constructor(scope: Construct, id: string, config:any, props?: StackProps) {
        ...
        //lambda
        const lambdaStack = new ProductFinderSchedulerLambda(this, 'launchProductFinderSchedulerLambdaConstruct', schedulerDynamodb.allowUserTable.tableName, schedulerSns.topic.topicArn);
        //add api gateway
        const apiStack = new ProductFinderSchedulerApi(this, 'launchProductFinderSchedulerApiConstruct', lambdaStack.lambda);
    }
